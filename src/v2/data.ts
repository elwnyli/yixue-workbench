...
export const seedWorkspace: Workspace = {
  ...
  projects: [{
    ...
    audience: '高校教师与教育管理者', style: '正式、简洁、审慎', deadline: '', status: 'active', memoryId: 'tm-personal',
    termbaseId: 'tb-personal', styleGuideId: 'style-academic', enabledSkills: ['builtin.terminology-consistency', 'builtin.mt-tone-check'],
    aiPretranslate: false, mtToneCheck: true, strictTerminology: true,
    files: [{ id: 'file-demo', name: 'human-agency.md', type: 'markdown', structure: 'headings', createdAt: now, segments: [
      { id: 'seg-demo-1', order: 1, source: 'Human oversight remains essential when automated systems influence decisions that affect people.', target: '当自动化系统影响关系到人的决策时，人工监督仍然不可或缺。', initialTarget: '当自动化系统影响人们的决定时，人的监督仍然重要。', status: 'confirmed', origin: 'human', note: '保留责任主体。', revisions: [] },
      { id: 'seg-demo-2', order: 2, source: 'Educational uses of AI should strengthen human agency, transparency, and accountability.', target: '', initialTarget: '', status: 'untranslated', origin: 'human', note: '', revisions: [] },
      { id: 'seg-demo-3', order: 3, source: 'Technology should support judgement rather than replace it.', target: '', initialTarget: '', status: 'untranslated', origin: 'human', note: '', revisions: [] },
  ...
  reviewRecords: [],
  news: [
    { id: 'news-unesco', title: '人工智能伦理建议书：教育与人的能动性', source: 'UNESCO', publishedAt: '持续更新资源', url: 'https://www.unesco.org/en/artificial-intelligence/recommendation-ethics', summary: '用于了解人工监督、透明度、问责和人的能动性等概念。此处为平台编写的资源摘要，不是网页原文。', level: 'B2—C1', tags: ['AI伦理', '教育'], trainingDirection: '练习政策语篇中的抽象概念与责任主体表达。', sourceNote: '真实来源入口；训练文本需由用户从可使用内容中选择。', saved: false },
    { id: 'news-ec', title: '翻译与清晰写作资源入口', source: 'European Commission', publishedAt: '持续更新资源', url: 'https://commission.europa.eu/resources-partners/translation-and-drafting-resources_en', summary: '欧盟委员会提供的翻译、起草和多语资源入口，可用于机构语篇与清晰语言训练。', level: 'B2—C1', tags: ['清晰语言', '机构翻译'], trainingDirection: '比较名词化表达与以读者行动为中心的中文改写。', sourceNote: '真实来源入口；平台不保存整篇网页内容。', saved: true },
  ],
  skills: [
  ...
  qualityIssues: [],
  settings: { theme: 'light', learnerName: '译学者', provider: 'demo', model: 'deepseek-chat', endpoint: '', temperature: 0.3, requestLimit: 6000, batchSize: 12, autoSave: true },
  lastSavedAt: now,
}
